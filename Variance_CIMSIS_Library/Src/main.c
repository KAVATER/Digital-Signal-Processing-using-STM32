...
float32_t mean_val_cmsis;
float32_t variance_val_cmsis;
float32_t standard_deviation_cmsis;
...
int main ()
{
   fpu_enable();
	...
	/*Using CMSIS Library*/
	arm_std_f32((float32_t*)inputSignal_f32_1kHz_15kHz, sig2_len, &standard_deviation_cmsis);
